...
<!-- Mirrored from 7oroof.com/demos/koira/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Nov 2024 07:14:27 GMT -->
<head>
  <meta charset="UTF-8" />
    ...
    <section id="slider1" class="slider slider-1">
      <div class="video-background-holder">
        ...
        <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
              <source src="assets/index_mv01.mp4" type="video/mp4">
          </video>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="service-item">
              <div class="service__content">
                ...
                <h4 class="service__title">Our Vision, Mission <br> and Core Values</h4>
                <p class="service__desc">Pioneering a world where the ocean and humanity co-exist in harmony</p>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="service-item">
              <div class="service__content">
                ...
                <h4 class="service__title">Mid-term Business <br>  Plan 2024-2026</h4>
                <p class="service__desc">Explore a Sustainable Future with Innovation</p>
                <a href="#" class="btn btn__secondary btn__link">
                  <span>Read More</span>
                  <i class="icon-arrow-right"></i>
                </a>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="service-item">
              <div class="service__content">
                ...
                <h4 class="service__title">Sustainability</h4>
                <p class="service__desc">Contribution to Society and Development of a Sustainable Future</p>
                <a href="#" class="btn btn__secondary btn__link">
                  <span>Read More</span>
                  <i class="icon-arrow-right"></i>
                </a>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="service-item">
              <div class="service__content">
                ...
                <p class="service__desc">Global Leading Player in Connecting Ocean and Humanity</p>
                <a href="#" class="btn btn__secondary btn__link">
                  <span>Read More</span>
                  <i class="icon-arrow-right"></i>
                </a>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 bg-theme">
            <div class="inner-padding">
              <div class="heading heading-3 heading-white mb-50">
                <h2 class="heading__title">OFS INDIAis recognized as one of the World's leading Industry & Manufacturing
                  Corporation!</h2>
                <p class="heading__desc">OFS INDIAhas been building relationships that last, serving impressive list of
    ...
    <section id="portfolioCarousel" class="portfolio-carousel pt-120 pb-90">
      <div class="container">
        <div class="row heading heading-2 mb-40">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            <p class="heading__desc">OFS INDIAhas been building relationships and projects that last. Serving an impressive
