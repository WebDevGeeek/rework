...
<body>
  <div class="wrapper">
    ...
    <img src="assets/images/loader/k31.png" alt="image" class="for-mobile img-fluid">
    <img src="assets/images/loader/k33.png" alt="image" class="for-desktop img-fluid">
    <a href="<?php echo base_url()?>" class="home_redirect"><button>Home</button></a>
    </div>
  </div>
  ...
  ">
    ...
    ">
          ...
          <p class="ofs" style="padding:10px; font-size: clamp(14px, 2vw, 1.5rem);"> At OFS India, we offer exciting opportunities with a collaborative work environment, where innovation and teamwork drive our success.
           <br><br><span style="font-size: clamp(1.7rem, 2vw, 1.5rem); ">  Explore multiple Career Opportunities and apply by clicking the link below </span></p>
          </p>
